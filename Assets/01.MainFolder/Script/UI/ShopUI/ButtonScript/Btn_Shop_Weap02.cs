...
public class Btn_Shop_Weap02 : MonoBehaviour
{
    Shop_Menu _ShopMenu;
    ...
    void Start()
    {
        ...
        m_Image_Btn_Weap02 = GameObject.Find("Image Weap02").GetComponent<Image>();
        m_InGameUIMgr = GameObject.Find("GameUI Manager").GetComponent<InGameUIMgr>();
        m_PriceBG = GameObject.Find("Weap02 PriceBG");
        m_Image_CoinIcon = GameObject.Find("Weap02 Coin Icon").GetComponent<Image>();
    }

    // Update is called once per frame
    void Update()
    {
        m_Image_Btn_Weap02.sprite = WeaponList.m_tWeapInfo[m_iWeaponNUM]._WeapImage;
        _ShopMenu.m_txtPrice02.text = string.Format("{0:n0}", WeaponList.m_tWeapInfo[m_iWeaponNUM]._iPrice);
    ...
    {
        if (m_Image_Btn_Weap02.sprite != m_NowEquipmentBox.m_SecondaryImage.sprite &&
            m_Image_Btn_Weap02.sprite != m_NowEquipmentBox.m_PrimaryImage.sprite)
        {
            if (m_PlayerStat.m_iPocketMoney >= WeaponList.m_tWeapInfo[m_iWeaponNUM]._iPrice)
            {
                ...
                if (WeaponList.m_tWeapInfo[m_iWeaponNUM]._tWeapType == WeaponList.WeapType.Secondary)
                {
                    ...
                    m_NowEquipmentBox.m_SecondaryImage.sprite = m_Image_Btn_Weap02.sprite;
                    m_InGameUIMgr.m_TabImg_SecondaryWeap.sprite = m_Image_Btn_Weap02.sprite;
                ...
                if (WeaponList.m_tWeapInfo[m_iWeaponNUM]._tWeapType == WeaponList.WeapType.Primary)
                {
                    ...
                    m_NowEquipmentBox.m_PrimaryImage.sprite = m_Image_Btn_Weap02.sprite;
                    m_InGameUIMgr.m_TabImg_PrimaryWeap.sprite = m_Image_Btn_Weap02.sprite;
