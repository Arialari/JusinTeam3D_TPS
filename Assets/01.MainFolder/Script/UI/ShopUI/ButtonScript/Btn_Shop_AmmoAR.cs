...
public class Btn_Shop_AmmoAR : MonoBehaviour
{
    Shop_Menu _ShopMenu;
    Image _AmmoAR_Image;
    ...
    void Start()
    {
        ...
        _AmmoAR_Image = GameObject.Find("Icon_AmmoAR").GetComponent<Image>();
        m_Img_PriceBG = GameObject.Find("AR PriceBG").GetComponent<Image>();
        m_Icon_Coin = GameObject.Find("AR Coin Icon").GetComponent<Image>();
    }
    ...
    public void MouseOver()
    {
        ...
        {
            _ShopMenu.m_Info_ItemImage.sprite = _AmmoAR_Image.sprite;

            _ShopMenu.m_txtName.text = "¼ÒÃÑ Åº¾à";
            _ShopMenu.m_txtKind.text = "Åº¾à";
            _ShopMenu.m_txtCharTitle.text = "Åº¼ö·®:";
            _ShopMenu.m_txtChar.text = "30¹ß";
            _ShopMenu.m_txtExplane.text = "µ¹°Ý¼ÒÃÑ¿¡ »ç¿ëµÇ´Â Åº¾àÀÌ´Ù.";
    ...
    public void MouseClick()
    {
        if (m_PlayerStat.m_iPocketMoney >= 50 &&
            m_PlayerStat.m_iTotalAmmo[(int)Weapon.Type.AR] < 999)
        {
            m_PlayerStat.MinusPocketMoney(50);
            m_PlayerStat.m_iTotalAmmo[(int)Weapon.Type.AR] += 30;
        }
    }
